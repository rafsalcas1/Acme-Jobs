...
@Service
public class AnonymousInvestorsrecordsShowService implements AbstractShowService<Anonymous, Investorsrecords> {

	@Autowired
	private AnonymousInvestorsrecordsRepository repository;
